...
const Navbar = () => {
  ...
  return (
    <nav className="w-full  top-0 left-0 bg-white shadow-md  ">
      <div className="max-w-7xl mx-auto px-8  py-[10px]  flex justify-between items-center">
...
>
  {isOpen ? (
    ...
    <HiOutlineMenu className="text-gray-600" />
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed top-[65px] left-0 w-full h-[calc(110vh-80px)] bg-white flex flex-col  transition-all duration-800 ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"
          }`}
      >
