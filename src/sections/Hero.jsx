    ...
    return (
        ...
        <div className="hsection" >
            ...
            <div className=" absolute inset-0 z-0 pointer-events-none">
                <img src={Sticker1}
                    className=" absolute top-[7%] left-[10%]   w-26 sm:w-14 lg:w-40 rotate-[-20deg]" />
                <img src={Sticker2}
                    className="  absolute top-[4%] right-[12%] w-26 sm:w-30 lg:w-40 -z-40 rotate-[15deg]" />
                <img src={Sticker3}
            ...
            <div className='flex flex-col items-center justify-center text-center px-5 mb-38 whitespace-nowrap space-y-6 '>
                <h1 className='text-2xl md:text-3xl lg:text-4xl  xl:text-5xl text-black  font-serif [word-spacing:-3px]'>I am
                    <span className="relative inline-block overflow-hidden top-3.5  md:top-4.5 rounded-lg m-1 mb-2 ">
                        {/* Animated Black Background */}
                        <span className="name-bg absolute left-0 top-0 h-full w-full bg-black origin-left scale-x-0"></span>
                        {/* Text */}
                        <span className="relative z-10 font-[font1] text-3xl md:text-4xl lg:text-5xl xl:text-6xl px-2.5  text-white">
                            Lavesh Bhagwani
                        </span>
                    </span>
                    ...
                    <br />
                    <span className="relative inline-block overflow-hidden top-1.5 md:top-2.5 ml-2 mr-2  rounded-lg  ">
                        {/* Animated Black Background */}
                        <span className="name-bg absolute left-0 top-0 h-full w-full bg-black origin-left scale-x-0"></span>
                        {/* Text */}
                        <span className="relative z-10 font-[font1]  text-3xl md:text-4xl lg:text-5xl xl:text-6xl px-2.5 text-white ">
                    ...
                    <br className='block md:hidden' />
                    <span className="relative inline-block overflow-hidden  md::top-2.5 ml-2  rounded-lg lg:top-2.5 ">
                        {/* Animated Black Background */}
                        <span className="name-bg absolute left-0 top-0 h-full w-full bg-black origin-left scale-x-0"></span>
                        {/* Text */}
                        <span className="relative z-10 font-[font1]   text-3xl md:text-4xl lg:text-5xl xl:text-6xl px-2.5 text-white ">
